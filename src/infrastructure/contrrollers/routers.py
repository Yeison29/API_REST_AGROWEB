...
class ApiRouter:
    ...
    def _setup_routes(self):
        ...
        self.router.get("/get-all-users", status_code=200, response_model=List[UserModelOut], tags=['user'])(ApiRest.get_all_users)
        self.router.post("/api/create-user", status_code=201, response_model=UserModelOut, tags=['user'])(ApiRest.add_user)
        self.router.get("/api/get-user-by-id", status_code=200, response_model=UserModelOut, tags=['user'])(ApiRest.get_user_by_id)
        self.router.put("/api/update-user", status_code=200, response_model=UserModelOut, tags=['user'])(ApiRest.update_user)
        self.router.delete("/api/delete-user", status_code=204, response_model=None, tags=['user'])(ApiRest.delete_user)
        self.router.post("/api/create-gender", status_code=201, response_model=GenderModelOut, tags=['gender'])(ApiRest.add_gender)
        ...
        self.router.put("/api/update-gender", status_code=200, response_model=GenderModelOut, tags=['gender'])(ApiRest.update_gender)
        self.router.delete("/api/delete-gender", status_code=204, response_model=None, tags=['gender'])(ApiRest.delete_gender)
        self.router.post("/api/create-type-document", status_code=201, response_model=TypeDocumentModelOut, tags=['type document'])(
            ApiRest.add_type_document)
        self.router.get("/api/get-all-type-documents", status_code=200, response_model=List[TypeDocumentModelOut], tags=['type document'])(
            ApiRest.get_all_type_documents)
        self.router.get("/api/get-type-document-by-id", status_code=200, response_model=TypeDocumentModelOut, tags=['type document'])(
            ApiRest.get_type_document_by_id)
        self.router.put("/api/update-type-document", status_code=200, response_model=TypeDocumentModelOut, tags=['type document'])(
        ...
        self.router.post("/api/create-country", status_code=201, response_model=CountryModelOut, tags=['country'])(
            ApiRest.add_country)
        self.router.get("/api/get-all-countries", status_code=200, response_model=List[CountryModelOut], tags=['country'])(
        ...
        self.router.post("/api/create-department", status_code=201, response_model=DepartmentModelOut, tags=['department'])(
            ApiRest.add_department)
        self.router.get("/api/get-all-departments", status_code=200, response_model=List[DepartmentModelOut], tags=['department'])(
            ApiRest.get_all_departments)
        self.router.get("/api/get-department", status_code=200, response_model=DepartmentModelOut, tags=['department'])(
            ApiRest.get_department_by_id)
        self.router.put("/api/update-department", status_code=200, response_model=DepartmentModelOut, tags=['department'])(
        ...
        self.router.post("/api/create-municipality", status_code=201, response_model=MunicipalityModelOut, tags=['municipality'])(
            ApiRest.add_municipality)
        self.router.get("/api/get-all-municipalities", status_code=200, response_model=List[MunicipalityModelOut], tags=['municipality'])(
            ApiRest.get_all_municipalities)
        self.router.get("/api/get-municipality", status_code=200, response_model=MunicipalityModelOut, tags=['municipality'])(
            ApiRest.get_municipality_by_id)
        self.router.put("/api/update-municipality", status_code=200, response_model=MunicipalityModelOut, tags=['municipality'])(
        ...
        self.router.post("/api/create-harvest", status_code=201, response_model=HarvestModelOut, tags=['harvest'])(
            ApiRest.add_harvest)
        self.router.get("/api/get-all-harvests", status_code=200, response_model=List[HarvestModelOut], tags=['harvest'])(
        ...
        self.router.get("/api/most-planted-crop-by-municipality", status_code=200, response_model=List[dict], tags=['statisticas'])(
        ...
        self.router.get("/api/most-widely-planted-crops", status_code=200, response_model=List[dict], tags=['statisticas'])(
        ...
        self.router.get("/api/table-price", status_code=200, response_model=List[dict], tags=['statisticas'])(
            ApiRest.table_price)
        self.router.get("/api/home", status_code=200, response_model=dict, tags=['home'])(
            ApiRest.home)
